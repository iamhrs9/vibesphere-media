(function () {
    ...
    function bindChatSocketListeners() {
        ...
        chatSocket.on('receive_message', (msg) => {
            if (document.getElementById('adminChatMessages')) {
                appendAdminMessageUI(msg);
            }
        });

        chatSocket.on('message_deleted', (id) => {
        ...
        chatSocket.on('message_pinned', (msg) => {
